...
function FolderSVG({ color = "#E8C4C4" }) {
  return (
    <svg width="56" height="48" viewBox="0 0 56 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        fill={color === "#E8C4C4" ? "#EDD0D0" : color}
        opacity="0.7"
      />
    </svg>
  )
...
function FileSVG() {
  return (
    <svg width="44" height="52" viewBox="0 0 44 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 2H28L40 14V50C40 51.1 39.1 52 38 52H6C4.9 52 4 51.1 4 50V2Z" fill="#F5DADA" stroke="rgba(180,100,108,0.3)" strokeWidth="1"/>
...
function TrashSVG() {
  return (
    <svg width="44" height="52" viewBox="0 0 44 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="8" y="10" width="28" height="36" rx="3" fill="#F5DADA" stroke="rgba(180,100,108,0.3)" strokeWidth="1"/>
      <rect x="6" y="8" width="32" height="4" rx="2" fill="#E8C4C4"/>
      <rect x="16" y="4" width="12" height="5" rx="2" fill="#E8C4C4" stroke="rgba(180,100,108,0.3)" strokeWidth="1"/>
